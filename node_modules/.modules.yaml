...
hoistedDependencies:
  ...
  /jest-circus/29.5.0:
    jest-circus: private
  /jest-cli/29.5.0_skxcisbnntvwqykzjpzwatlj3a:
    jest-cli: private
  /jest-config/29.5.0_skxcisbnntvwqykzjpzwatlj3a:
    jest-config: private
  /jest-diff/29.5.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Mon, 13 Mar 2023 02:35:54 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/tuhacrt/Library/pnpm/store/v3
